export const gate_back_left_wall = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const GateLefWall = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_left/gate_back_left.json"
    });

    const GateLeftDoor = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_left/gate_back_left_door.json"
    });

    const GateLeftTopDoor = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_left/gate_back_left_door_top.json"
    });
