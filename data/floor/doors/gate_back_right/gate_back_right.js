export const gate_back_right_wall = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const GateRightWall = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_right/gate_back_right.json"
    });

    const GateRightDoor = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_right/gate_back_right_door.json"
    });

    const GateRightTopDoor = new GeoJSONLayer({
        url: "./data/floor/doors/gate_back_right/gate_back_right_door_top.json"
    });
