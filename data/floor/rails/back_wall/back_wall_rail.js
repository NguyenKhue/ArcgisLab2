export const back_wall_rail = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const floorBackWallRailRoot = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.root.geojson.json"
    });

    const floorBackWallRailColumn1 = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.column1.geojson.json"
    });

    const floorBackWallRailColumn2 = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.column2.geojson.json"
    });

    const floorBackWallRailWall1 = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.wall1.geojson.json"
    });

    
    const floorBackWallRailWall2 = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.wall2.geojson.json"
    });

    const floorBackWallRailWall3 = new GeoJSONLayer({
        url: "./data/floor/rails/back_wall/floor.back.wall.rail.wall3.geojson.json"
    });
