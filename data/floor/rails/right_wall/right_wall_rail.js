export const right_wall_rail = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const floorRightWallRailRoot = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.root.geojson.json"
    });

    const floorRightWallRailColumn1 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.column1.geojson.json"
    });

    const floorRightWallRailColumn2 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.column2.geojson.json"
    });

    const floorRightWallRailColumn3 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.column3.geojson.json"
    });

    const floorRightWallRailColumn4 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.column4.geojson.json"
    });

    const floorRightWallRailColumn5 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.column5.geojson.json"
    });


    const floorRightWallRailWall1 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.wall1.geojson.json"
    });

    const floorRightWallRailWall2 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.wall2.geojson.json"
    });

    const floorRightWallRailWall3 = new GeoJSONLayer({
        url: "./data/floor/rails/right_wall/floor.right.wall.rail.wall3.geojson.json"
    });
