export const back_wall = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const backWallPart1 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part1.geojson.json"
    });

    const backWallPart2 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part2.geojson.json"
    });


    const backWallPart3 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part3.geojson.json"
    });


    const backWallPart4 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part4.geojson.json"
    });


    const backWallPart5 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part5.geojson.json"
    });


    const backWallPart6 = new GeoJSONLayer({
        url: "./data/floor/walls/back_wall/floor.back.wall.part6.geojson.json"
    });
