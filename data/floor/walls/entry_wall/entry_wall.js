export const entry_wall = (Map, SceneView, GeoJSONLayer, SceneLayer,
    ...
    const entryWallPart1 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part1.geojson.json"
    });

    const entryWallPart2 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part2.geojson.json"
    });


    const entryWallPart3 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part3.geojson.json"
    });


    const entryWallPart4 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part4.geojson.json"
    });


    const entryWallPart5 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part5.geojson.json"
    });


    const entryWallPart6 = new GeoJSONLayer({
        url: "./data/floor/walls/entry_wall/floor.entry.wall.part6.geojson.json"
    });
